...
Domain model presenting relationship between the Azure \textit{Cloud-based\ front-end} and \textit{Cyber-physical\ node} attached to the \textit{Cyber-physical\ node} is presented in Fig. \ref*{} \textit{Cloud-based Front-end} and Cyber-physical node, PubSub Gateway, Device, Design and development tools
