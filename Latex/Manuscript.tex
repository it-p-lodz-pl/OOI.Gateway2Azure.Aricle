...
of the Internet of Things paradigms. OPC UA Part 14 PubSub \todo{add ref} \footnote{Mariusz Postol, UA Part 14: PubSub Main Technology Features in Object Oriented Internet, https://github.com/mpostol/OPC-UA-OOI, 2019, DOI: 10.5281/zenodo.1198852} offers the
...
Sect.~\ref*{ooi-main-technology-features} provides more detailed description of this library and new functionality (\texttt{Embedded\ Gateway} \todo{refine the text} part deployment process.
