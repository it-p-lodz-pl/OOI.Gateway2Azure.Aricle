...
\section{Azure Main Technology Features}\label{azure-main-technology-features}}
...
authorization %MP authorization can be applied only to operations ?% to selected resources and operations including but not
...
\hypertarget{ooi-main-technology-features}{%
  \section{OOI Main Technology Features}\label{ooi-main-technology-features}}
