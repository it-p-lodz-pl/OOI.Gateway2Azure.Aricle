...
\begin{enumerate}
      ...
      \item \textit{CommunicationContext} - to handling communication with the Azure services (Sect. \ref*{sub.AzureInteroperability})
\end{enumerate}

In this case, the implementation of the \textit{IConfigurationFactory} interface is straightforward and based entirely on the \textit{Networking} library. In a typical scenario, this implementation should not be considered for further modification. It is ready to provide all necessary configuration parameter to establish semantic and security contexts related to Azure interoperability.
