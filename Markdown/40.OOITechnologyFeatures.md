...
To address multi-vendor environment a standard solution is require => PubSub. The specyfication is abstrack, so concrete oimplementation has been selected OOI. 
